    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                <Link :href="route('events.index')" class="text-gray-400 transition hover:text-gray-600">
        ...
        <ConvocationSheet :players="players" :store-route="route('convocations.store', event.id)" />
    </AuthenticatedLayout>
</template>
